...
-- CREATE VIEW
-- Query returned successfully in 43 msec.
-- Successfully run. Total query runtime: 2 secs 379 msec. 
...
-- Successfully run. Total query runtime: 38 min 39 secs.
SELECT * FROM gr2;
...
-- Successfully run. Total query runtime: 2 hr 38 min.
SELECT * FROM gr3;
